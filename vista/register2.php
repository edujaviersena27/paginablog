...
<nav class="navbar navbar-default" role="navigation">
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="login.php" style="font-family: 'Lobster', cursive;">DevEdiII</a>
		</div>
		<!-- menu items -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Mediante la simple utilización de DevEdiII y al contratar cualquiera de los servicios ofrecidos a través de DevEdiII, el Cliente reconoce haber leído y acepta los términos expuestos en el presente Acuerdo y / o las políticas que formen parte del mismo.
        <br>
        <br>
        <p>
        	<b>Uso de la cuenta de usuario en DevEdiII</b>
        </p>
		<p>
			<ul>
